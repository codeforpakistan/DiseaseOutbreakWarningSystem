...
<body><div class="page-wrapper">
        ...
        <div class="body">
            ...
            <div class="body-wrapper">
                ...
                <div class="content">
                    <div class="container" >
                       <div style="display:inline;">  <div class="sixteen map columns">
                                <iframe width="100%" height="640" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="map.php"></iframe>
                                <div class="sdw"></div>
                        </div>
